    ...
    return (
        <div className='max-w-[1000px] mx-auto flex flex-col lg:flex-row text-white/70 p-8
            ...
            <div className='flex justify-center items-center'>
                <ul>
                    <li className='flex item-center'>
                        ...
                        <p className='text-xl'>159999999</p>
                    </li>
                    <li className='flex item-center'>
                        <Image src={mail} alt='email' className='h-[100px] w-auto mr-6' />
                        <p className='text-xl'>andriel.h@aluno.ifsp.edu.br</p>
                    </li>
                </ul>
            </div>
            <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
                ...
                <form className='space-y-4' action="htpps/getform.io/yourEndpoint" method="POST">
                    ...
                    <button className='bg-orange-700 hover:bg-orange-500 text-white px-6 py w-full font-semibold text-xl rounded-xl'>Send Message</button>
